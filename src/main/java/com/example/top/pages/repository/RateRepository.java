...
public interface RateRepository extends JpaRepository<Rate, String> {
    ...
    @Query(value="select r.id, r.\"comment\", r.user_id, r.ispositive, r.isapproved, r.item, i.\"name\" from rate r left join item i on r.item = i.id where r.user_id = :userUUID and i.id = :itemUUID", nativeQuery = true)
    Optional<Rate> getItemAndRateByUserAndItem(String userUUID, String itemUUID);
}
